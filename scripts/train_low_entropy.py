...
def run_fictitious_ppo(args):
    ...
    for episode in range(1, num_episodes + 1):
        ...
        if not args.smoke_test and episode % 100 == 0:
            ...
            chk_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "checkpoints", f"TITAN_LOW_ENTROPY_01_epoch_{epoch_num:03d}.pt")
    ...
    if args.smoke_test:
        ...
        # Save final weights
        final_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "checkpoints", "TITAN_LOW_ENTROPY_FINAL.pt")
